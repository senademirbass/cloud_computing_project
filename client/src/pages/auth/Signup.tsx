...
export default function Signup() {
  ...
  useTitle('Ücretsiz Hesap Oluştur | AnketKOU');
    ...
    mutation.mutate(data, {
      ...
      onError: err => {
        if (isAxiosError(err)) {
          ...
          let errorMsg =
            (err.response?.data?.message as string) || 'Kayıt başarısız!';
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Hesap oluşturmak için mail adresinizi girin.
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex-col gap-3">
          ...
          <div className="flex justify-center gap-2 text-sm">
            <p className="text-muted-foreground">Zaten bir hesabınız var mı?</p>
